...
function saveWaterMetersInfoToConfig() {
    ...
    var param = {
        location:   'Settings',
        action:     'actionSaveWaterMetersInfoToConfig',
        config:     'Water',
...
function eraseWaterMetersInfoFromConfig() {
    ...
    var param = {
        location:   'Settings',
        action:     'actionEraseWaterMetersInfoFromConfig',
        config:     'Water',
    };
