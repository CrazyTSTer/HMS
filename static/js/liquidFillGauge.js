...
(function(d3) {
    ...
    d3.liquidfillgauge = function(g, value, settings, custom_text) {
        ...
        g.each(function(d) {
            ...
            gauge.on("valueChanged", function(newValue, custom_text) {
                transition(value, newValue, config.get("waveRise"), config.get("valueCountUp"), custom_text);
                value = newValue;
            });
